...
void GraphicsPipeline::Create(const GraphicsPipelineDescriptor& desc, GraphicsPipelineResource& resource)
{
    ...
    auto vkRes = vkCreateDescriptorSetLayout(device, &descriptorLayoutInfo, allocator, &resource.descriptorSetLayout);
    if (vkRes != VK_SUCCESS)
    {
    ...
    pipelineLayoutInfo.pSetLayouts = &resource.descriptorSetLayout;
...
void GraphicsPipeline::Destroy(GraphicsPipelineResource& resource)
{
    ...
    vkDestroyDescriptorSetLayout(LogicalDevice::GetVkDevice(), resource.descriptorSetLayout, Instance::GetAllocator());
}

void GraphicsPipeline::OnImgui(GraphicsPipelineDescriptor& desc, GraphicsPipelineResource& resource)
{
