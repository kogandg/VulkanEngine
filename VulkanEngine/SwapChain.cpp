...
void SwapChain::Create()
{
    ...
    // create swapchain
    {
        ...
        {
            std::cerr << "Querying less images than the necessary!" << std::endl;
        ...
        {
            std::cerr << "Querying more images than supported. imageCoun set to maxImageCount." << std::endl;
    ...
    // create resources
    {
        ...
        if (!validFormat)
        {
            throw std::runtime_error("Failed to find valid format for depth resource!");
        }
...
VkPresentModeKHR SwapChain::choosePresentMode(const std::vector<VkPresentModeKHR>& presentModes)
{
    ...
    std::cout << "Preferred present mode not available!" << std::endl;
...
VkSurfaceFormatKHR SwapChain::chooseSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& formats)
{
    ...
    std::cout << "Preferred surface format not available!" << std::endl;
    return formats[0];
}
